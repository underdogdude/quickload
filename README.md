...
- **Admin app:** `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `DATABASE_URL`, `LINE_CHANNEL_ACCESS_TOKEN` (for pushes), `LINE_INTERNAL_NOTIFY_USER_ID` (Quickload Glow admin alerts), `APP_ENV`, `LEGACY_API_BASE_URL`

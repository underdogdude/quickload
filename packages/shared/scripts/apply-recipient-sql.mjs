...
const sqlPath = path.join(__dirname, "../sql/20260214_recipient_addresses.sql");
const sql = fs.readFileSync(sqlPath, "utf8");

const sqlClient = postgres(url, { max: 1 });
try {
  await sqlClient.unsafe(sql);
  console.log("Applied packages/shared/sql/20260214_recipient_addresses.sql successfully.");
} finally {

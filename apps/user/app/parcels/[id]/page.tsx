              ...
              <article className="rounded-lg bg-white p-4 shadow-sm ring-1 ring-slate-200">
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center gap-1 rounded-md border border-slate-300 bg-white px-3 py-3 text-sm font-semibold text-slate-700"
                  >
                  ...
                  {/* Download disabled — LINE in-app browser cannot save PDFs reliably
                  <button
                    type="button"
